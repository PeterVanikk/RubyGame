...
public class SkeletonIdle : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        RaycastHit2D playerchk = Physics2D.Raycast(rigidbody2d.position, lookDirection, 6.5f, LayerMask.GetMask("Player"));
        RaycastHit2D playerbehindchk = Physics2D.Raycast(rigidbody2d.position, -lookDirection, 3.5f, LayerMask.GetMask("Player"));
